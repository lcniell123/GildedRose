...
L- SellinValueTest - All items have a SellIn value which denotes the number of days we have to sell the item
L- QualityValueTest - All items have a Quality value which denotes how valuable the item is

-   LowerValuesPerDayTest- At the end of each day our system lowers both values for every item
    Pretty simple, right? Well this is where it gets interesting:

L- QualityDegradesTest - Once the sell by date has passed, Quality degrades twice as fast
L- QualityNeverNegativeTest.java -The Quality of an item is never negative

-   AgedBrieTest.java - "Aged Brie" actually increases in Quality the older it gets
    L- QualityNorMore50.java - The Quality of an item is never more than 50
-   SulfurasTest.java - "Sulfuras", being a legendary item, never has to be sold or decreases in Quality
